"""
Django settings for cuberz_crazzy_48716 project.
...
ROOT_URLCONF = 'cuberz_crazzy_48716.urls'
...
WSGI_APPLICATION = 'cuberz_crazzy_48716.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Cuberz crazzy Support <support@cuberz-crazzy-48716.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cuberz_crazzy_48716 API",
    "DESCRIPTION": "API documentation for cuberz_crazzy_48716 App",
    "VERSION": "v1",
}
